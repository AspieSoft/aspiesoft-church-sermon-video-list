...
if(!class_exists('AspieSoftChurchSermonVideoList')){
  ...
  class AspieSoftChurchSermonVideoList{
    ...
    function enqueue(){
      wp_enqueue_style('aspieSoftChurchSermonVideoListStyle', plugins_url('/assets/style.css', __FILE__), array(), '1.3.3');
      wp_enqueue_script('aspieSoftChurchSermonVideoListScript', plugins_url('/assets/script.js', __FILE__), array('jquery'), '1.5.2', true);
    }
